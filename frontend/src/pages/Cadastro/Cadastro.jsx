...
return (
  <div className="min-h-screen flex flex-col items-center justify-center pb-5 bg-[#fff8f0]">
    ...
    <div className="bg-white rounded-3xl shadow-2xl shadow-black/40 p-10 w-full max-w-[800px] flex flex-col items-center gap-6">
    ...
    <div className="flex gap-10">
        <Input label="Nome completo" type="text" placeholder="Seu nome" icon={FaRegUser} value={nome}
        onChange={(e) => setNome(e.target.value)}
        />
        <Input label="CPF" type="text" placeholder="000.000.000-00" icon={FaRegAddressCard} value={cpf}
